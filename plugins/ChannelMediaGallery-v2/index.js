(function () {
  ...
  if (!storageRoot.channelMediaGalleryFixed) storageRoot.channelMediaGalleryFixed = {};
  var storage = storageRoot.channelMediaGalleryFixed;
  var timer = null;
  var fetchedChannels = {};
  var remoteChannels = {};
  ...
  function Settings() {
    ...
    return React.createElement(ScrollView, { style: { padding: 16 } },
      React.createElement(Text, { style: { color: "white", fontSize: 24, fontWeight: "900" } }, "Channel Media Gallery Fixed 2.0.0"),
