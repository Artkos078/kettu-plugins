(function () {
  ...
  if (!storageRoot.channelMediaGalleryV3) storageRoot.channelMediaGalleryV3 = {};
  var storage = storageRoot.channelMediaGalleryV3;
  var timer = null;
  var fetchedChannels = {};
  var remoteChannels = {};
  ...
  function Settings() {
    ...
    return React.createElement(ScrollView, { style: { padding: 16 } },
      React.createElement(Text, { style: { color: "white", fontSize: 24, fontWeight: "900" } }, "Channel Media Gallery Fixed 3.0.0"),
