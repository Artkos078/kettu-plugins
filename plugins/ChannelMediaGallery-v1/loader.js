...
function urls(){
  ...
  out.push('https://raw.githubusercontent.com/Artkos078/kettu-plugins/main/plugins/ChannelMediaGallery-v1/index.js?'+tag);
  out.push('https://github.com/Artkos078/kettu-plugins/raw/main/plugins/ChannelMediaGallery-v1/index.js?'+tag);
  return out;
}
...
function Settings(){
  ...
  return React.createElement(ScrollView,{style:{padding:16}},
    React.createElement(Text,{style:{color:'white',fontSize:24,fontWeight:'900'}},'Channel Media Gallery Loader 1.1.17'),
