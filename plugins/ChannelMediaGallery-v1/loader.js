...
function urlList(){var t='v=1.1.23&t='+Date.now();var a=[];try{if(V.plugin&&V.plugin.id)a.push(String(V.plugin.id).replace(/\/?$/,'/')+'index.js?'+t);}catch(e){}a.push('https://raw.githubusercontent.com/Artkos078/kettu-plugins/main/plugins/ChannelMediaGallery-v1/index.js?'+t);return a;}
...
function Settings(){
 ...
 return React.createElement(Scroll,{style:{padding:16}},
  React.createElement(Text,{style:{color:'white',fontSize:24,fontWeight:'900'}},'Channel Media Gallery Config 1.1.23'),
...
var out={default:plugin,__esModule:true,onLoad:onLoad,onUnload:onUnload,start:onLoad,stop:onUnload,settings:Settings,Settings:Settings,SettingsComponent:Settings,getSettingsPanel:Settings};
return out;
})()
