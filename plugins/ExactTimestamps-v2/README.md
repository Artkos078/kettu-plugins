...
Version 2.0.0 directly patches Kettu's inline Discord timestamp parser. Smart
...
```text
https://raw.githubusercontent.com/Artkos078/kettu-plugins/main/plugins/ExactTimestamps-v2
```
